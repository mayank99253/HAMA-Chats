...
const Chatpage = () => {
  ...
  return (
    <div className='h-screen w-screen flex items-center justify-center relative font-sans overflow-hidden'>
      <AestheticBackground />
      <div className='h-[80vh] w-[70vw] max-w-7xl bg-white/[0.01] backdrop-blur-3xl border border-white/10 rounded-[3rem] flex overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)] z-10'>
